...
from dlgo import ReinforcementLearning
...
def main():
    ...
    collector1 = ReinforcementLearning.ExperienceCollector()
    collector2 = ReinforcementLearning.ExperienceCollector()
    ...
    experience = ReinforcementLearning.combine_experience([collector1, collector2])
